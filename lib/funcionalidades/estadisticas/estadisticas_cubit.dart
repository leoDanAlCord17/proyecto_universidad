...
class EstadisticasCubit extends Cubit<EstadisticasEstado> {
  ...
  Future<EstadisticasCargadas> _resolverTodo(FiltrosEstadisticas filtros) async {
    // v2
    ...
    await Future.wait([
      resumenFuture,    porTipoFuture,  porMesFuture,    porEstatusFuture,
      topFuture,        porDiaFuture,   porCreadorFuture, opcionesFuture,
      tasaPorTipoFuture, tendenciaFuture, escalaFuture,  topTagsFuture,
      topAsistentesFuture, composicionFuture, estadoFuture, heatmapFuture,
    ]);
