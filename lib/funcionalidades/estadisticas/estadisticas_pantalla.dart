              ...
              child: InkWell(
                ...
                child: const Padding(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.filter_alt_off_rounded, color: ColoresApp.rojo, size: 16),
                      SizedBox(width: 4),
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.tune_rounded,
                      color: totalActivos > 0 ? ColoresApp.blanco : ColoresApp.acento, size: 18),
