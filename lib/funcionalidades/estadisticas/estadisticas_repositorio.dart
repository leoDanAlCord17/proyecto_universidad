...
class EstadisticasRepositorio {
  ...
  Future<ResumenEstadisticas> obtenerResumen(FiltrosEstadisticas f) async {
    try {
  ...
  Future<List<DatoGrafica>> obtenerEventosPorTipo(FiltrosEstadisticas f) async {
    try {
  ...
  Future<List<DatoGrafica>> obtenerEventosPorMes(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoGrafica>> obtenerAsistenciaPorEstatus(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<EventoTopStat>> obtenerTopEventos(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoGrafica>> obtenerAsistenciaDiaSemana(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoCreador>> obtenerEventosPorCreador(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<OpcionesFiltros> obtenerOpciones(FiltrosEstadisticas f) async {
    try {
      final datos = await _supabase.rpc(
  ...
  Future<List<DatoTasaTipo>> obtenerTasaPorTipo(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoTendenciaDual>> obtenerTendenciaDual(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoGrafica>> obtenerEscalaEventos(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoTag>> obtenerTopTags(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<AsistenteFrecuente>> obtenerTopAsistentes(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<ComposicionMes>> obtenerComposicionMensual(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoGrafica>> obtenerEstadoEventos(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
  ...
  Future<List<DatoHeatmap>> obtenerHeatmapHora(FiltrosEstadisticas f) async {
    try {
      final filas = await _supabase.rpc(
