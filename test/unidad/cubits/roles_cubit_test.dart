...
import 'package:uniasist/funcionalidades/roles/roles_cubit.dart';
import 'package:uniasist/funcionalidades/roles/roles_estado.dart';
...
void main() {
  ...
  setUp(() {
    repositorio = MockRolesRepositorio();
  });
  ...
  group('RolesCubit.cargarRoles', () {
    ...
    blocTest<RolesCubit, RolesEstado>(
      ...
      build: build,
      setUp: () {
        when(() => repositorio.obtenerRoles())
            .thenAnswer((_) async => _roles);
    ...
    blocTest<RolesCubit, RolesEstado>(
      ...
      setUp: () {
        when(() => repositorio.obtenerRoles())
            .thenAnswer((_) async => [_rEstudiante]);
        when(() => repositorio.contarUsuariosPorRol())
  ...
  group('RolesCubit.filtrar', () {
    RolesCargados cargados() => const RolesCargados(
      roles:          _roles,
    ...
    blocTest<RolesCubit, RolesEstado>(
      ...
      build: build,
      // Seed con filtro parcial para que la restauración sea diferente al estado actual
